<%@ Page Title="Allergy Master" Language="vb" AutoEventWireup="false" MasterPageFile="~/StudentMaster.master" CodeBehind="AllergyMaster.aspx.vb" Inherits="iDiary_V3.AllergyMaster" %>
...
&nbsp;
                <asp:Button ID="btnRemove" runat="server" Text="Remove" CssClass="hvr-glow" Visible="False" />
                <br />
