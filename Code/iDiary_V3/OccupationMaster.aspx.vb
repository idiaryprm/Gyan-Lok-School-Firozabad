...
Public Class OccupationMaster
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        End If
        If txtID.Text = "" Then
            If CheckDoubleEntry(7, txtName.Text) > 0 Then
        ...
        If chkDefault.Checked = True Then
            IsDefault = 1
            sqlStr = "Update Occupation Set IsDefault=0"
        ...
        If txtID.Text = "" Then
            ...
            sqlStr = "Insert into Occupation Values('" & txtName.Text & "'," & IsDefault & ")"
        Else
            'Update
            sqlStr = "Update Occupation Set OccName='" & txtName.Text & "',IsDefault=" & IsDefault & " Where OccID=" & Val(txtID.Text)
        End If
    ...
    Protected Sub lstMasters_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles lstMasters.SelectedIndexChanged
        ...
        Dim sqlStr As String = "Select * From Occupation Where OccName='" & lstMasters.Text & "'"
        
        
        
        Dim myReader As SqlDataReader = ExecuteQuery_ExecuteReader(sqlStr)
        While myReader.Read
            txtID.Text = myReader("OccID")
            txtName.Text = myReader("OccName")
            Try
    ...
    Protected Sub btnRemove_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRemove.Click
        ...
        Dim sqlStr As String = "Delete From Occupation Where OccID=" & Val(txtID.Text)
