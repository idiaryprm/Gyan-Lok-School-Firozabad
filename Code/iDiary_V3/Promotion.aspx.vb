...
Public Class Promotion
    ...
    Protected Sub btnPromote_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPromote.Click
        ...
        Dim CASID As Integer = FindMasterID(1, cboCurrentAcademicSession.Text)
        ...
        Dim NASID As Integer = FindMasterID(1, cboNextAcademicSession.Text)
        ...
        For i = 0 To chkStudList.Items.Count - 1
            ...
            If chkStudList.Items.Item(i).Selected = True Then
                ...
                Dim SchoolID As Integer = FindMasterID(71, cboSchoolNameNext.Text)
                ...
                sqlStr = "Insert into Student (SchoolID,StudentID,RegNo,ClassRollno,FeeBookNo,CSSID,HouseID,ASID,Promoted,PhotoPath,FeeConfigType,UserID) "
                sqlStr += " SELECT " & SchoolID & ",StudentID,RegNo,ClassRollno,FeeBookNo,CSSID,HouseID,ASID,Promoted,PhotoPath,FeeConfigType,UserID FROM Student WHERE SID=" & OldSID
                ...
                sqlStr = "Update Student Set CSSID=" & NewCSSID & ", classrollno='0' , ASID=" & NASID & ", Promoted=0, PromotionDate='" & DateAndTime.Now.Date.ToString("yyyy/MM/dd") & "' Where SID=" & NewSID
               ExecuteQuery_Update(sqlStr)
        ...
        Dim NClass As String = cboNextClass.Text & "-" & cboNextSection.Text
        ...
        lblStatus.Text = "Selected Students of Class " & CClass & " promoted to " & NClass & " successfully..."
    ...
    Private Sub LoadStudents(type As Integer)
        ...
        " AND Promoted=0 AND StatusName='" & cboStatus.Text & "' and SchoolName='" & cboSchoolNameCurrent.Text & "' "
        If cboCurrentSubSection.Text <> "" Then
            sqlStr += " and SubSecName='" & cboCurrentSubSection.Text & "'"
        End If
        sqlStr += " Order By gender desc,sname"
    ...
    Protected Sub btnListPromotion_Click(sender As Object, e As EventArgs) Handles btnListPromotion.Click
        ...
        Dim sqlStr As String = "Select RegNo from vw_Student Where ASID=" & FindMasterID(1, cboCurrentAcademicSession.Text) & " AND className='" & cboCurrentClass.Text & "' AND SecName='" & cboCurrentSection.Text & "' AND StatusName='" & cboStatus.Text & "'"
        ...
        End With
        Dim Param As String = "Promotion List for Class : " & cboCurrentClass.Text & " - " & cboCurrentSection.Text & " for the Session : " & cboCurrentAcademicSession.Text
