<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="ExamDateSheet.aspx.vb" Inherits="iDiary_V3.ExamDateSheet" %>
                        ...
                        <td colspan="7">
                            <div id="gvDiv" style=" max-height: 400px; overflow-y: scroll; text-align: center;">
                                <asp:Label ID="lblClassName" runat="server" Text="" style="font-weight: 700"></asp:Label>
                                 <asp:GridView ID="gvExamDateSheet" runat="server" DataKeyNames="SubjectName" AutoGenerateColumns="False" CellPadding="4" DataSourceID="GVCreateMarksEntry" CssClass="Grid" GridLines="Horizontal" ShowFooter="True" Visible="False" Width="95%">
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="Sr. No.">
                                                 ...
                                                 <asp:TemplateField HeaderText="Date">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtDate" runat="server" DataFormatString="{0:dd/MM/yyyy}"  CssClass="textbox" TextMode="Date"  Width="140px" />
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                </asp:TemplateField>
                                              <%--   <asp:TemplateField HeaderText="Day">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtDay" runat="server"  CssClass="textbox"  Width="140px" />
                                                    </ItemTemplate>
                                                    <ItemStyle Font-Bold="True" HorizontalAlign="Center" VerticalAlign="Middle" />
                                                </asp:TemplateField>--%>
                                                 <asp:TemplateField HeaderText="Time From">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtTime" runat="server" CssClass="textbox" TextMode="Time"   Width="120px" />
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                </asp:TemplateField>
                                                 <asp:TemplateField HeaderText="Time To">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtTimeTo" runat="server" CssClass="textbox" TextMode="Time"   Width="120px" />
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                </asp:TemplateField>
                             ...
                             <asp:SqlDataSource ID="GVCreateMarksEntry" runat="server" ConnectionString="<%$ ConnectionStrings:iDiaryConnectionString %>" SelectCommand="SELECT SubjectName FROM [vw_ExamSubjectMapping]  Where ClassName='' AND SecName=''  AND subGrpID=1"></asp:SqlDataSource>
                        </td>
                    </tr>
                  <tr>
