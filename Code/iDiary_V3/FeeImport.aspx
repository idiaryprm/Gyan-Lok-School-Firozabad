<%@ Page Language="VB" MasterPageFile="~/MasterPage.Master" AutoEventWireup="false" Inherits="iDiary_V3.ImportMarks" title="Untitled Page" Codebehind="FeeImport.aspx.vb" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <tr>
            ...
            <td align="left" style="height: 21px; font-weight: 700;" colspan="3">
                <asp:Button ID="btnCheckExcel" runat="server" Text="Validate  Fee" Width="120px" />
            &nbsp;&nbsp;&nbsp;
        ...
        <tr>
            ...
            <td align="left" colspan="7" style="margin-left: 40px">
               <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:iDiaryConnectionString %>" SelectCommand="SELECT [SNo], [Dated], [Details], [Amount] FROM [tmpFeeReject] where Type=1 order by SNo">
                </asp:SqlDataSource>
