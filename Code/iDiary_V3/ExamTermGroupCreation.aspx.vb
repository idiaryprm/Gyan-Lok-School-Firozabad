...
Partial Class ExamTermGroupCreation
    ...
    Private Sub GvCreateTable()
        ...
        Dim rv As String = ""
        Dim CSSID As Integer = FindCSSID(cboClass.SelectedItem.Text, cboSection.SelectedItem.Text, cboSubSection.SelectedItem.Text)
        ...
        For Each gvr As GridViewRow In GvMyTable.Rows
            ...
            sqlstr = "select DisplayType,EntryType,ApplicableInExam,ApplicableInTimeTable,TTWeightage from ExamSubjectMapping where subjectID=" & SubjectID & " AND CSSID=" & CSSID & " AND ASID=" & ASID
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Next
        If SubCount = 0 Then
            lblStatus.Text = "Please Select at least one Subject to Map..."
            GvMyTable.Focus()
            Exit Sub
        End If
        GvSaveData()
    ...
    Private Sub GvSaveData()
        ...
        For Each gvr As GridViewRow In GvMyTable.Rows
            ...
            sqlstr = "Delete From ExamSubjectMapping Where CSSID=" & CSSID & " AND SubjectID=" & SubjectID & ""
            ...
            If chkSelect.Checked = True Then
                ...
                sqlstr = "Insert into ExamSubjectMapping (CSSID, SubjectID,DisplayType,EntryType,ApplicableInExam,ApplicableInTimeTable,TTWeightage,ASID) Values " & _
                    "(" & CSSID & "," & SubjectID & "," & displayType & "," & entryType & "," & ExamVal & ",'" & TTVal & "','" & TTwt & "'," & ASID & ")"
                ExecuteQuery_Update(sqlstr)
    ...
    Protected Sub cboExamGroup_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboExamGroup.SelectedIndexChanged
        ...
        LoadClasses(cboClass, lblGrpID.Text)
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        If cboSubjectGroup.Text = "" Then
            ...
            Exit Sub
        End If
        sdsgvMytable.SelectCommand = "Select * From vw_ExamSubjects where subgrpID=" & cboSubjectGroup.SelectedItem.Value & " AND ExamGroupID Like '%:" & lblGrpID.Text & ":%' Order by SubjectName"
        GvMyTable.DataBind()
