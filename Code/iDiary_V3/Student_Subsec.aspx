<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="Student_Subsec.aspx.vb" Inherits="iDiary_V3.Student_Subsec" %>
<%@ Register assembly="Microsoft.ReportViewer.WebForms, Version=11.0.0.0, Culture=neutral, PublicKeyToken=89845dcd8080cc91" namespace="Microsoft.Reporting.WebForms" tagprefix="rsweb" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Heading" runat="server">
    Student Sub-Section Allocation
</asp:Content>
  ...
  <%--<br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br />
    ...
    <tr>
        ...
        <td valign="top" width="60%">
            ...
            <br />
            <br />
                        <asp:Button ID="btnPromote" runat="server"  Text = "Allocate Sub section" class="btn btn-primary"/>
            <br />
            <br />
