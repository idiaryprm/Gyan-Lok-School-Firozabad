...
Public Class DVDMaster
    ...
    Private Sub InitControls()
        ...
        txtAccNo.Text = ObjLib.FindNextAccessionNo("D")
        txtTitle.Text = ""
        txtBookCodeNo.Text = ""
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If txtNoOfBooks.Enabled = True Then
            ...
            For i = 0 To NoOfBooks - 1
                ...
                sqlStr += "Remark,Issued,Vender,BillNo,BillDate,PhotoPath,Frequency,DateIn) Values(" & _
                "'" & AccNo & "'," & _
                ...
                AccNo = ObjLib.FindNextAccessionNo("D")
