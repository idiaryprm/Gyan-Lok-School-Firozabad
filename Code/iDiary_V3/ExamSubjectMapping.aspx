<%@ Page Language="VB" MasterPageFile="~/ExamAdminMasterPage.master" AutoEventWireup="false" Inherits="iDiary_V3.ExamSubjectMapping" title="Untitled Page" Codebehind="ExamSubjectMapping.aspx.vb" %>
...
<%-- <br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br />
    ...
    <table class="table">
        ...
        <tr>
            <td style="width: 97px">School Name</td>
            <td colspan="3">
        ...
        <tr>
            <td style="width: 97px">Exam Group</td>
            <td>
        ...
        <tr>
            <td style="width: 97px">Sub-Section</td>
            <td>
                ...
                <asp:GridView ID="GvMyTable" runat="server" AutoGenerateColumns="False" CssClass="Grid" DataKeyNames="SubjectID" DataSourceID="sdsgvMytable" GridLines="Horizontal" Visible="true" Width="100%">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Entry Type" ItemStyle-HorizontalAlign="Center">
                          ...
                          <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Priority" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:Textbox ID="txtPriority"  TextMode="Number" CssClass="textbox" Width="40px" runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>
